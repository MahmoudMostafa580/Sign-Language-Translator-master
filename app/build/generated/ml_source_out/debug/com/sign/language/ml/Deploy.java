...
public final class Deploy {
  ...
  private Deploy(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "deploy.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Deploy newInstance(@NonNull Context context) throws IOException {
    return new Deploy(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Deploy newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Deploy(context, options);
  }
