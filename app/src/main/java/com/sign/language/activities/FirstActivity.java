...
public class FirstActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton backbtn = (ImageButton) findViewById(R.id.back_button_sign);
        ImageButton homebtn = (ImageButton) findViewById(R.id.home_button_sign);
